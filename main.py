...
from src.seed import seed_from_llms_txt, check_llms_coverage
from src.page_filter import filter_error_pages, filter_redirect_duplicates
...
def run_single_scope(args, scope: str, reporter: CrawlReporter,
    ...
    try:
        ...
        crawled_pages = filter_error_pages(crawled_pages)
        ...
        crawled_pages = filter_redirect_duplicates(crawled_pages)
